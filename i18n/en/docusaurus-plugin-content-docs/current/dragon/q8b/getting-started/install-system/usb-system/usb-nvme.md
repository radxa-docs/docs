...
This guide explains how to flash a system image to an NVMe SSD using a USB Type-C cable.

## Prerequisites

1. Install the NVMe SSD into the board's M.2 M Key 2280 NVMe SSD slot
