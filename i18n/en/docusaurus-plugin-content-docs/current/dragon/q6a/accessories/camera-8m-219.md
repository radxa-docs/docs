...
When using Debian packaged libcamera, the configuration file path may be different. If you need to modify the configuration file:

<NewCodeBlock tip='radxa@dragon-q6a$' type="device">

```bash
# Find libcamera configuration file location
find /usr -name "imx219.yaml" -type f 2>/dev/null

# If configuration file is found, you can edit it
# sudo nano /found/path/imx219.yaml
```
