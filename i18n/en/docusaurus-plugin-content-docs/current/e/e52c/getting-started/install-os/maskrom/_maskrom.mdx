...
- Prepare a USB A-A cable as shown below

![MaskRom Key](/img/e/e52c/radxa-e52c-maskrom-a-a-cable.webp)

- First plug the USB A-A cable into the USB 3.0 OTG/HOST Type-A port of the E52C and the other end into your computer.

![MaskRom Key](/img/e/e52c/radxa-e52c-maskrom-1.webp)

- Then press and hold the **Maskrom button**.
