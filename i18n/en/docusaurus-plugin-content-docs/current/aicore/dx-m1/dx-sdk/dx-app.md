...
Navigate to the `dx-all-suite/dx-runtime/dx_app` directory
...
:::warning
If you are using radxa os 6.1 kernel system and using the script installation method, please modify line **183** in install.sh to set the recommended opencv version to 4.7.0 (default is 4.5.5), otherwise compilation errors will occur
:::

### Compile DX-APP

:::tip
When compiling DX-APP, you need to be in a Python virtual environment. Please enter the Python virtual environment created when [**compiling DX-RT**](./dx-rt#compile-dx-rt)
:::
...
### Download Test Models/Images/Video Resources
...
Source code location: `./demos/classification/classification_sync.cpp`
...
Source code location: `./demos/object_detection/yolo_1channel.cpp`
...
Please refer to the following JSON to construct the configuration file
...
Source code location: `./demos/pose_estimation/yolo_pose.cpp`
...
Source code location: `./demos/segmentation/segmentation.cpp`
...
:::tip
Before using Python for model inference, please ensure you have entered the virtual environment where the [**dx-engine Python library**](dx-rt#install-dx-rt-python-library) is installed
:::

### ImageNet Python Example

Source code location: `./templates/python/imageNet_example.py`
...
Source code location: `templates/python/yolov5s_example.py`
