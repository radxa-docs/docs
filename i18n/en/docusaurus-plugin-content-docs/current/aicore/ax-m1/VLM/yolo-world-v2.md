...
This document explains how to run the [YOLO-World-V2](https://github.com/AILab-CVC/YOLO-World) sample application on a host device equipped with the Radxa AICore AX-M1.
...
Available devices: {'host': {'available': False, 'version': '', 'mem_info': {'remain': 0, 'total': 0}}, 'devices': {'host_version': 'V3.6.4_20250819020149', 'dev_version': 'V3.6.4_nt': 1, 'devices_info': [{'temp': 45, 'cpu_usage': 2, 'npu_usage': 0, 'mem_info': {'remain': 7022, 'total': 7040}}]}}
...
If your board IP address is 192.168.1.100, open your browser and visit: http://192.168.1.100:7860.
