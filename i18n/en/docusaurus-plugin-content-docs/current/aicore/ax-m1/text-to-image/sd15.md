...
This document explains how to run the [StableDiffusion 1.5 LCM](https://huggingface.co/latent-consistency/lcm-lora-sdv1-5) sample application on a host device equipped with the Radxa AICore AX-M1.
