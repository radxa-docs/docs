...
The ROCK Pi S is equipped with 2x 26-pin GPIO headers, providing highly flexible interface support for hardware expansion.

Users can connect various sensors, actuators, communication modules, displays, and other embedded peripherals through the GPIO ports, enabling rapid prototyping and functional verification in fields such as IoT (Internet of Things), robotics control, and industrial automation.

<div style={{ textAlign: 'center' }}> 26 Pin GPIO Header 1 </div>

<TabItem value="26 Pin GPIO Header 1">
...
<div style={{ textAlign: 'center' }}> 26 Pin GPIO Header 2 </div>

<TabItem value="26 Pin GPIO Header 2">
     <div className='gpio_style' style={{ overflow :"auto"}}  >
