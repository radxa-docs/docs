...
Download the [RKDevTool](https://dl.radxa.com/tools/windows/RKDevTool_Release.zip) tool, then extract the downloaded file. The `RKDevTool.exe` is the executable program - simply double-click to run the software.
