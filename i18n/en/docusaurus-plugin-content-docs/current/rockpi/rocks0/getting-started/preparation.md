...
The Radxa 4P to USB-A Male Cable is a 4-Pin MX1.25mm to Male USB cable that can be connected to a 5V adapter to power the ROCK Pi S0 or directly to a host computer for communication.

![rocks0 otg](/img/rockpi/s0/rocks0-otg-wire.webp)

### USB HOST Cable

The Radxa 4P to USB-A Female Cable is a 4-Pin MX1.25mm to female USB cable that provides the ROCK Pi S0 with an interface to USB devices.

![rocks0 usb](/img/rockpi/s0/rocks0-usb-wire.webp)

### 100Mbps Ethernet Cable

The Radxa 4P to Ethernet Adapter Cable is a 4-Pin MX1.25mm to Ethernet adapter cable that provides access to a 100Mbps Ethernet network for the ROCK Pi S0.
