...
2. Please refer to [Environment Preparation](../../low-level-dev/install-os-on-emmc.md#environment-preparation) to load [ android-bootloader.img ](https://dl.radxa.com/zero/images/loader/android-bootloader.img). You can boot into fastboot mode.
