...
- The device BIOS is updated to a recent version: see [BIOS Update](../low-level-dev/bios.md)
...
1. Plug the USB drive into Orion O6 and select the USB drive from the BIOS boot menu
2. Choose `Graphical Install` in the installer menu
3. Select the SSD used as the fnOS system disk and complete partitioning and Swap settings (system partition ≥ 64 GB recommended)
