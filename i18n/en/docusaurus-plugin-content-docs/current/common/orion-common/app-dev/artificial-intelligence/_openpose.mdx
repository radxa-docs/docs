...
![openpose_npu2](/img/orion/o6/openpose_npu2.webp)
...
Results are saved in the `output` folder
![openpose_onnx1](/img/orion/o6/openpose_onnx1.webp)

![openpose_onnx2](/img/orion/o6/openpose_onnx2.webp)
