...
The following commands require loading `envtoo.sh` first:

- `help`: Display SDK command help
- `build radxa`: Compile all components and generate the final runnable image

## Build Artifacts

After `build radxa` completes, you can find the following build artifacts:
