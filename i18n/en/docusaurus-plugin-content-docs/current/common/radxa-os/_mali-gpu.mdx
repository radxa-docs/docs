...
2. <div className="red">
     <strong>
       ...
       reinstall the Rockchip proprietary software packages 
       (if you don't perform this step it will crash the desktop or flip the colors) {" "}
     </strong>
   </div>
...
2. <div className="red">
     <strong>
       Then refer to [System Upgrade Using `rsetup`](./rsetup#system-update) to
       reinstall the Debian's officially packages 
       (if you don't perform this step it will crash the desktop or flip the colors.){" "}
     </strong>
   </div>
