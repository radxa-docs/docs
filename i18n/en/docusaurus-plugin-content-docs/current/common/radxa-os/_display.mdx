...
You can rotate your screen display by modifying the [System Settings-Display Settings](./display#system-settings-display-settings).
...
If you want to make this configuration persistent, you can refer to the following configuration file (KDE desktop environments strictly follow their own system settings, please refer to [System Settings-Display Settings](./display#system-settings-display-settings)):
