...
Example terminal output (where `sda` is the system disk of the motherboard in this example). You can identify the correct device by safely removing and reconnecting the removable medium.
...
- `/dev/sda`: The disk corresponding to the motherboard
