...
- The UFS module is installed on the board or the board has onboard UFS

## Hardware Connection

Follow the instructions based on your board configuration.

:::tip
This tutorial applies to multiple board models. Choose the appropriate steps for hardware connection based on your board configuration.

Boards with onboard UFS typically don't have a UFS module interface and don't require installation.
:::
