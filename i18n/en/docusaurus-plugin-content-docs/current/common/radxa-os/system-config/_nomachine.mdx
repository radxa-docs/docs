...
To install the virtual display driver, you need to add Ubuntu's universe software repository:
...
Add the following `universe` repository to the end of the file and save:
