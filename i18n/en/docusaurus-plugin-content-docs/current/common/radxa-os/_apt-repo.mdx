...
This mirror is provided by [LZUOSS](mailto:oss.lzu.edu.cn@gmail.com).

```bash
sudo sed -i "s|https://radxa-repo.github.io|https://mirrors.lzu.edu.cn/git/radxa-apt/raw/branch/gh-pages|g" /etc/apt/sources.list.d/radxa*.list
sudo apt-get update
```
...
sudo sed -e "s|https://radxa-apt.aghost.cn|https://radxa-repo.github.io|g" \
         ...
         -e "s|https://mirrors.lzu.edu.cn/git/radxa-apt/raw/branch/gh-pages|https://radxa-repo.github.io|g" \
