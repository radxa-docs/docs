...
:::warning
Do not use the `apt-get update` command to update the system, as this will result in an incomplete update, which may lead to abnormal or missing functionality, or even a failure to boot the system.  
You should use [`rsetup`](#system-update) to update the system.
:::.
...
<Details summary="Device Tree Configuration">

<Devicetree />

</Details>

<Details summary="Install 3rd party overlay">

<InstallOverlays />

</Details>

<Details summary="Adding LEDs">

<Addled />

</Details>

<Details summary="Configure Pins 8 and 10 as GPIOs">

<DisableFIQ />

</Details>

<Details summary="Configure UART2_M0 as normal serial port">
