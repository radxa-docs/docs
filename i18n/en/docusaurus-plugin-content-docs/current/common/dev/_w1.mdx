...
<a href="../../radxa-os/rsetup#overlays">Device Tree configuration</a> to enable
One Wire related Overlay, e.g. "Enable {props.w1_overlay_name}".

## Connection

Connect {props.product_name} and One Wire device as follows
