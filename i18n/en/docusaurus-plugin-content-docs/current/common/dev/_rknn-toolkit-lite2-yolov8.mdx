...
**Radxa has provided pre-converted `yolov8.rknn` models, users can directly refer to [Inference YOLOv8 on the Board](#inference-yolov8-on-the-board) to skip the PC-side Model Conversion section**
...
- Run the yolov8 example program

  If you are using your own converted model you need to copy it from the PC to the board, and specify the model path with the --model_path parameter.
