...
- Run the yolov8 example program
  ...
  If you are using your own converted model you need to copy it from the PC to the `/usr/share/rknn_model_zoo/examples/yolov8/model` directory on the board.
