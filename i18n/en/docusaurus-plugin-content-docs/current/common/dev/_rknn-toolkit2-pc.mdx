:::tip
This document demonstrates how to use `rknn-toolkit2` on an x86 PC to perform simulation inference of the YOLOv5 segmentation model without a motherboard. For the required environment setup, please refer to [RKNN Installation](./rknn-install).
:::
