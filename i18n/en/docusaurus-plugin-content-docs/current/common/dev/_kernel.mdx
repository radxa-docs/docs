...
In the case of Radxa ZERO 3, the linux profile is `rk356x`. Here are the profiles for other products:
...
Then put the product profile `rk356x` into the `profile` parameter of the bsp command, e.g. `./bsp linux rk356x` to build the kernel.  
