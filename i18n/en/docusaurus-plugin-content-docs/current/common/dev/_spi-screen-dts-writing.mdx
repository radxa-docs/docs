...
<img src="/img/common/ili9486_search_results.webp" style={{ width: "40%" }}  alt="ili9486 search results" />

According to the official website or the manual, we can know that the Waveshare 3.5 inch SPI LCD Model B is a small TFT display.
...
<img src="/img/common/ili9486_search_results.webp" style={{ width: "40%" }} alt="ads7846 search results" />
...
- Prepare the Overlay development environment according to <a href={props.load_overlay} >Overlay Development</a>.
...
- Name the dts file rock-3c-waveshare35.dts

- Move the file to the radxa-overlays/arch/arm64/boot/dts/rockchip/overlays/ directory

- Add the file name to radxa-overlays/arch/arm64/boot/dts/rockchip/overlays/Makefile

- Compiling linux from <a href={props.load_overlay} >Overlay Development</a> Compile linux-rk356x as follows
...
- Copy the file radxa-overlays/arch/arm64/boot/dts/rockchip/overlays/rock-3c-waveshare35.dtbo to Radxa ROCK 3C
