...
:::tip
Radxa provides a pre-converted `yolov5s_rk35XX.rknn` model. Users can skip the PC-side model conversion section and directly refer to [YOLOv5 Inference on Device](#板端推理-yolov5).
:::
