...
<p>Please refer to<a href="../os-config/rsetup#overlays">the device tree configuration </a> to enable PWM-related Overlay. eg: "Enable {props.pwm_name}".</p>

### Connection

<p>As shown in the picture，connect {props.product_name}'s {props.pwm_pin}</p>
