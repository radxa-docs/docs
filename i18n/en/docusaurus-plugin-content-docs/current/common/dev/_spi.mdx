...
<ul>
  ...
  <li>One female-to-female Dupont wire</li>
</ul>

### Enable Overlay

<p>
  Please refer to <a href="../../radxa-os/rsetup#overlays">device tree config </a>Enable SPIDEV Related
  Overlay, eg: "Enable {props.spi_overlay_name}"。
</p>

### Connection

<p>
  Short {props.spi_mosi} and {props.spi_miso} as shown
</p>

<img src={props.spi_connection} alt="spi connection" style={{ width: "80%" }} />
...
If the output is consistent with _default_tx_ (if the output is consistent with the following), then the spi loopback test was successful
