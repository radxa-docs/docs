...
<pre>
  ...
  insert the microSD card into the MicroSD slot of {props.product}(as shown below), power on the
  system with the {props.power_supply} power adapter, and then the system will
  start booting and HDMI will display the desktop.
</pre>
