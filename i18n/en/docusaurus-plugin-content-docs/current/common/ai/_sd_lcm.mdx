...
- Download the Stable Diffusion v1.5 LoRa models' compressed package:
  ...
  Users can also compile any stable_diffusion v1.5 checkpoints using model_export.py and [TPU-MLIR](../../model-compile). For details, please refer to [model_export/README](https://github.com/zifeng-radxa/SD-lcm-tpu/blob/radxa_v0.2.0/model_export/README.md).
