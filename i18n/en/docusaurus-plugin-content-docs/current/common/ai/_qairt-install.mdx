...
- Pull the Docker image
  ...
  <Tabs queryString="platform">
    ...
    <TabItem value="QCS9075" default={props.tag === "qcs9075"} attributes={{className: props.tag === "qcs6490" && "tab_none"}}>
      ...
      :::tip
      In the `radxazifeng278/qairt-npu-9075:v1.1` image, the QAIRT directory is located at `/root/qairt`. If you are unsure after entering the container, confirm it with:
