...
- Enter the ACUITY Toolkit Docker Container
  ...
  :::tip
  Specify NPU_VERSION: use `v3` for A733 and `v2` for T527. For reference, see [**NPU Version Comparison Table**](cubie-acuity-usage#npu-version-comparison)
  :::
...
:::tip
Specify NPU_SW_VERSION: Select v2.0 for A733, select v1.13 for T527. For NPU information, please refer to the [NPU Version Comparison Table](./cubie-acuity-usage#npu-version-comparison)
:::
