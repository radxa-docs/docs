...
- On the PC side, use [ACUITY Toolkit](./cubie-acuity-sdk#acuity-toolkit) to convert models from different frameworks to NBG format
...
:::tip
Specify NPU_SW_VERSION: use `v2.0` for A733 and `v1.13` for T527. Please refer to the [NPU Version Comparison Table](./cubie-acuity-usage#npu-version-comparison-table) for NPU information.
:::
