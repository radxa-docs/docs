...
This example uses the pre-trained ONNX format model from [ultralytics/yolov5](https://github.com/ultralytics/yolov5/releases/tag/v6.0) as an example to demonstrate the complete process of converting the model for inference on the board.
...
:::tip
Radxa provides a pre-converted `yolov5.nb` model. Users can directly refer to [**YOLOv5 Inference on the Board**](#yolov5-inference-on-the-board) and skip the PC model conversion section.
:::

:::tip
The files used in the YOLOv5 example are already included in the [ai-sdk example repository](https://github.com/ZIFENG278/ai-sdk.git) under `models/yolov5s-sim`.
:::

- Enter the ACUITY Toolkit Docker container.

  For ACUTIY Toolkit Docker environment preparation, please refer to [ACUITY Toolkit Environment Configuration](./cubie_acuity_env)
...
- Create model input/output files.
  ...
  Use [Netron](https://netron.app/) to confirm the input/output names of the ONNX model.
  ...
  <div style={{ textAlign: "center" }}>
    <img src="/en/img/cubie/a7a/yolov5_input.webp" />
...
<div style={{ textAlign: "center" }}>
  <img src="/en/img/cubie/a7a/yolov5_result.webp" />
  YOLOv5s demo output
</div>
