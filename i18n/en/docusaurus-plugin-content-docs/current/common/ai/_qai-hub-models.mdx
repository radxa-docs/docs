...
Leveraging the cloud services provided by [QAI-Hub](https://app.aihub.qualcomm.com/docs/index.html), it supports online **quantization, compilation, inference, analysis, and downloading** of models from the [Model List](#model-list) on cloud devices through command-line interface.
...
:::tip
First, register an account and log in to [Qualcomm® AI Hub](https://aihub.qualcomm.com/) to obtain your **`API Token`**
:::
...
This example demonstrates how to compile the [RealESRGAN_x4plus](https://github.com/xinntao/Real-ESRGAN) model into a Context-Binary format with 128x128 input size and w8a8 quantization for NPU inference on QCS6490 SoC, providing a simple introduction to using Qualcomm® AI Hub Models for model compilation.
...
:::tip
For detailed usage of qai_hub_models.models.real_esrgan_x4plus.export, use **`--help`**
...
### QAI HUB MODELS Model Inference Demo

Based on the final prompt in the [Model Compilation Example](#qai-hub-models-model-compilation-example), you can perform inference on the compiled model on cloud devices and view the inference results.
...
<div style={{ textAlign: "center" }}>
  ...
  Specific parameter location for hub-model-id
</div>
<NewCodeBlock tip="Device" type="device">
...
<div style={{ textAlign: "center" }}>
  <img
    ...
    style={{ width: "90%" }}
  />
  Left: Result image, Right: Input image
</div>
