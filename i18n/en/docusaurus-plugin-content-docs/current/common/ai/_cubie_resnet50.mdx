...
:::tip
Radxa provides a pre-converted `resnet50.nb` model. Users can directly refer to [**On-board ResNet50 Inference** ](#on-board-resnet50-inference) to skip the PC-side model conversion chapter.
:::
