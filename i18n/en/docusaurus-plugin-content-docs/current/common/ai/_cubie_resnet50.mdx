...
- Enter the ACUITY Toolkit Docker Container
  ...
  :::tip
  Specify NPU_VERSION: use `v3` for A733 and `v2` for T527. For reference, see [**NPU Version Comparison Table**](cubie-acuity-usage#npu-version-comparison-table)
  :::
...
:::tip
Specify NPU_SW_VERSION: select `v2.0` for A733 and `v1.13` for T527. For NPU information, refer to [NPU Version Comparison Table](./cubie-acuity-usage#npu-version-comparison)
:::
