This document explains how to use the QAI AppBuilder Python library to run the [Inception-v3](https://aihub.qualcomm.com/models/inception_v3?domain=Computer+Vision&useCase=Image+Classification&chipsets=qualcomm-qcs6490-proxy) object detection model on the Radxa Dragon Q6A.

## Install QAI AppBuilder

:::tip
Please follow the [**QAI AppBuilder Installation Guide**](qai-appbuilder)
:::
