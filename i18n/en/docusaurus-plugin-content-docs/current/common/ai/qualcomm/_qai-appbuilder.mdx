...
```bash
git clone https://github.com/quic/ai-engine-direct-helper.git && cd ai-engine-direct-helper
git checkout 5e85a52
...
After compilation, a `qai_appbuilder-2.42.0.68-cp312-cp312-linux_aarch64.whl` file will be generated in the `dist` directory
...
```bash
cd dist
pip3 install ./qai_appbuilder-2.42.0.68-cp312-cp312-linux_aarch64.whl
```
...
```bash
cd ../../
ln -s qairt/2.42.0.251225/lib/aarch64-oe-linux-gcc11.2/ ai-engine-direct-helper/samples/python/qai_libs
```
