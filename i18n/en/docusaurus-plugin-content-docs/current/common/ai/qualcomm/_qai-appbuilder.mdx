...
| Dragon Q6A           | QCS6490 |
| Dragon Q8B           | Q8280 |
| Fogwise® AIRbox Q900 | Q9075 |

## Installation Methods

:::tip
You can [**install via wheel package**](#install-via-wheel-package) or [**build from source**](#build-from-source)
:::
...
:::tip
For Q8280 Demos, please refer to [**Demo Examples**](./qai-appbuilder-demo)
:::
...
:::tip
For Q9075 Demos, please refer to [**Demo Examples**](./qai-appbuilder-demo)
:::
