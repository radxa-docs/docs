...
<Tabs queryString="platform">
    ...
    <TabItem value="QCS8550" default={props.tag === "qcs8550"} attributes={{className: props.tag !== "qcs8550" && "tab_none"}}>

    <NewCodeBlock tip="Device" type="device">
    ```bash
    export PRODUCT_SOC=8550 DSP_ARCH=68
    ```
    </NewCodeBlock>
...
:::tip
For QCS8550 Demos, please refer to [**Demo Examples**](./qai-appbuilder-demo)
:::
