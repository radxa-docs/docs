This document explains how to use the [QAI AppBuilder](../qai-appbuilder) Python API to perform inference with the [Real-ESRGAN-x4plus](https://aihub.qualcomm.com/models/real_esrgan_x4plus?domain=Computer+Vision&useCase=Super+Resolution&chipsets=qualcomm-q6490-proxy) image super-resolution model using the Qualcomm® Hexagon™ Processor (NPU).
