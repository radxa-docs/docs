...
:::info[AIMET vs QAIRT Quantization]
...
:::info[AIMET Users Can Skip This Step]
...
The target quantized model is saved as `resnet50_quantized.dlc`. For more information on using `qairt-quantizer`, please refer to [**qairt-quantizer**](qairt-tools#qairt-quantizer).
...
- config_backend.json
  ...
  <TabItem value="Q6490" default={props.tag === "q6490"} attributes={{className: props.tag !== "q6490" && "tab_none"}}>
          ...
          Please select the appropriate dsp_arch and soc_id based on your SoC NPU architecture. Here we use Q6490 SoC as an example
          ...
          Please select the appropriate dsp_arch and soc_id based on your SoC NPU architecture. Here we use Q8280 SoC as an example
    ...
    <TabItem value="Q9075" default={props.tag === "q9075"} attributes={{className: props.tag !== "q9075" && "tab_none"}}>
          ...
          Please select the appropriate dsp_arch and soc_id based on your SoC NPU architecture. Here we use Q9075 SoC as an example
...
The generated Context-Binary is saved in `output/resnet50_quantized.bin`. For more information on using `qnn-context-binary-generator`, please refer to [**qnn-context-binary-generator**](qairt-tools#qnn-context-binary-generator).
...
- Copy NPU architecture-specific dynamic library files to the target board
  ...
  Select the appropriate hexagon folder based on your SoC NPU architecture. Here we use Q6490 as an example
...
- Execute Model Inference
  ...
  The results are saved in the `output_bin` directory. For more information on using `qnn-net-run`, please refer to [**qnn-net-run**](qairt-tools#qnn-net-run).
