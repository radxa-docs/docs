...
<Tabs queryString="platform">
    ...
    <NewCodeBlock tip="Device" type="device">
    ```bash
    export PRODUCT_CHIP=qualcomm-q6490-proxy
    ```
    </NewCodeBlock>
    ...
    <TabItem value="Q8280" default={props.tag === "q8280"} attributes={{className: props.tag !== "q8280" && "tab_none"}}>

    <NewCodeBlock tip="Device" type="device">
    ```bash
    export PRODUCT_CHIP=qualcomm-q8280-proxy
    ```
    </NewCodeBlock>
    ...
    <NewCodeBlock tip="Device" type="device">
    ```bash
    export PRODUCT_CHIP=qualcomm-q9075-proxy
    ```
    </NewCodeBlock>
...
```bash
(.venv) (base) radxa@vms-max:/mnt/sda1/qualcomm/qai-hub/ai_hub_model$ python3 -m qai_hub_models.models.real_esrgan_x4plus.export --chipset "qualcomm-q6490-proxy" --target-runtime qnn_context_binary  --height 128 --width 128 --quantize w8a8 --num-calibration-samples 10
...
python /mnt/sda1/qualcomm/qai-hub/.venv/lib/python3.10/site-packages/qai_hub_models/models/real_esrgan_x4plus/demo.py --eval-mode on-device --hub-model-id mm63gld2m --chipset qualcomm-q6490-proxy
```
...
```bash
(.venv) (gen_py3.10) radxa@vms-max:~/Job/git_clone/ai-hub-models$ python3 -m qai_hub_models.models.real_esrgan_x4plus.demo --eval-mode on-device --hub-model-id mm63gld2m --chipset qualcomm-q6490-proxy
