...
- Download the `2.42.0.251225` QAIRT SDK from [Qualcomm® Software Center](https://softwarecenter.qualcomm.com/catalog/item/Qualcomm_AI_Runtime_Community?osArch=Any&osType=All&version=2.42.0.251225)

    <NewCodeBlock tip="X86 Linux PC / Qualcomm Device" type="device">
...
- Pull the Docker image
  ...
  <Tabs queryString="platform">
    ...
    <TabItem value="QCS6490" default={props.tag === "qcs6490"} attributes={{className: props.tag !== "qcs6490" && "tab_none"}}>
      ...
      ```bash
      sudo docker pull radxazifeng278/qairt-npu-v68:v1.2
      ```
      ...
      ```bash
      sudo docker run --privileged -it -v /dev:/dev -v $(pwd):/workspace --name qairt-sdk radxazifeng278/qairt-npu-v68:v1.2 /bin/bash
      ```
    ...
    <TabItem value="Q9075" default={props.tag === "q9075"} attributes={{className: props.tag !== "q9075" && "tab_none"}}>
      ...
      ```bash
      sudo docker pull radxazifeng278/qairt-npu-9075:v1.1
      ```
      ...
      Note: In the `radxazifeng278/qairt-npu-9075:v1.1` image, the QAIRT directory is located at `/root/qairt`. If you are unsure after entering the container, confirm it with:
