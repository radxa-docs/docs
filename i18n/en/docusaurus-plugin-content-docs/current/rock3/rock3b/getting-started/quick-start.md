---
sidebar_position: 2
description: "Quick start with ROCK 3B / 3B+ to help you get started and explore its features."
---
...
- A 12V/2A or higher power PD adapter. The ROCK 3B / 3B+ also supports PoE power supply. For more details on power supply, please refer to [power-supply](./power-supply).
...
:::tip
The official [Radxa PD30W adapter](../../../accessories/power/pd-30w) is recommended.
:::

Peripherals that are not required but enhance the basic functionality of the ROCK 3B / 3B+:

- Heat sink, refer to [heat sink selection](./interface-usage/fan) to install the heat sink.
- M.2 wireless module: ROCK 3B / 3B+ supports standard M.2 Wi-Fi cards. Please check the [Wireless Module Compatibility List](./interface-usage/pcie-e-key#wifi--bt-支持模块列表). Some older driver-free M.2 Wi-Fi cards may also support plug-and-play.
...
1. Connect any of the HDMI output ports of the ROCK 3B / 3B+ to the HDMI monitor via the HDMI cable.

<img src="/img/rock3/3b/rock3b_hdmi.webp" width="500" alt="rock3b hdmi" />

2. Connect the USB mouse and keyboard to any USB 2.0 or 3.0 port on the ROCK 3B / 3B+.
...
5. Plug the power adapter into the power connector on the ROCK 3B / 3B+. The device will power up and start, the power indicator will light up.
