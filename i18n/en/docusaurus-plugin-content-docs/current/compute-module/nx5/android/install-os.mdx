...
NX5 can boot from microSD card or eMMC, so install os on microSD card or eMMC based on your choose.
...
Please go to [Download Summary](../getting-started/download.md) to download image.
...
2. Power up the NX5 Kit via the DC adapter.
3. The NX5 Kit will boot up with the green power LED on.
...
&emsp;[rkdeveloptool](../radxa-os/low-level-dev/rkdeveloptool.md)

&emsp;[upgrade_tool](../radxa-os/low-level-dev/upgrade-tool.md) (Can be installed to multiple devices simultaneously)
...
&emsp;[rkdevtool](../radxa-os/low-level-dev/rkdevtool.md)
...
1. Power on the NX5 Kit via the DC adapter.
2. The NX5 Kit will boot up with the green power LED on.
