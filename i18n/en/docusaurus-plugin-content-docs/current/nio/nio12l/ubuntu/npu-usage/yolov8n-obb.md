---
sidebar_position: 16
description: Complete workflow for YOLOv8n-OBB model conversion (Host) and deployment (Device) on NIO12L
---
...
After conversion, the following files are generated in `examples/yolov8n-obb/model/`:
...
```bash
wget -P examples/yolov8n-obb/model/int8 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n-obb_int8.dla
wget -P examples/yolov8n-obb/model/fp32 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n-obb_fp32.dla
```
...
```bash
./build/yolov8n-obb_demo --image assets/images/boats.jpg
```
...
Results are saved in `outputs/yolov8n-obb/` (`vis/` for visualization images, `detections/` for JSON).
