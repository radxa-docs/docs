...
After conversion, the following files are generated in `yolo26n/`:
...
```bash
scp yolo26n_mtk_int8.tflite <user>@<device>:/path/to/nio12l-model-zoo/models/yolo26n/int8/
scp yolo26n_mtk_fp32.tflite <user>@<device>:/path/to/nio12l-model-zoo/models/yolo26n/fp32/
```
