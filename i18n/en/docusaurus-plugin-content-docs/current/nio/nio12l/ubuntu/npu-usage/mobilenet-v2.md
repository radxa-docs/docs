---
sidebar_position: 5
description: Complete workflow for MobileNetV2 model conversion (Host) and deployment (Device) on NIO12L
---
...
After conversion, the following files are generated in `examples/mobilenet_v2/model/`:

- `int8/mobilenet_v2_mtk_int8.tflite`
- `fp32/mobilenet_v2_mtk_fp32.tflite`
...
```bash
wget -P examples/mobilenet_v2/model/int8 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/mobilenet_v2_int8.dla
wget -P examples/mobilenet_v2/model/fp32 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/mobilenet_v2_fp32.dla
```
...
```bash
scp mobilenet_v2_mtk_int8.tflite <user>@<device>:/path/to/nio12l-model-zoo/examples/mobilenet_v2/model/int8/
scp mobilenet_v2_mtk_fp32.tflite <user>@<device>:/path/to/nio12l-model-zoo/examples/mobilenet_v2/model/fp32/
```
...
```bash
cd examples/mobilenet_v2/model/int8
...
Results are saved in `outputs/mobilenet_v2/classifications/`.
