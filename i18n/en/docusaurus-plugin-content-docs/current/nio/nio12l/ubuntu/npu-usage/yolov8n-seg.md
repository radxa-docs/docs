---
sidebar_position: 22
description: Complete workflow for YOLOv8n-Seg model conversion (Host) and deployment (Device) on NIO12L
---
...
```bash
wget -P examples/yolov8n-seg/model/int8 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n-seg_int8.dla
wget -P examples/yolov8n-seg/model/fp32 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n-seg_fp32.dla
```
...
```bash
./build/yolov8n-seg_demo --image assets/images/bus.jpg --image assets/images/zidane.jpg
```
...
Results are saved in `outputs/yolov8n-seg/` (`vis/` for visualization images, `detections/` for JSON).
