...
After conversion, the following files are generated in `mobilenet_v1/`:
...
Default uses INT8 model with `assets/images/pickup.jpg` and `assets/images/rhodesian_ridgeback.jpg`:
