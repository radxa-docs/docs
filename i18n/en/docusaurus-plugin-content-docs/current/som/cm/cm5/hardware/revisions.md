...
- Add eMMC configuration on the Radxa CM5.
- Change the original eMMC interface of CM5 to SDMMC
- Remove the WIFI_HOST_WAKE_E network and add SD_PWR_ON
- Move the status indicator LED from the baseboard to the Radxa CM5.
...
- Move the 4 MOSFETs and 8 matching resistors controlled by HDMI0_TX_ON_H to the Radxa CM5.
- Move HDMI DDC and CEC signals from the IO board to the Radxa CM5, add level conversion UM3204H.
