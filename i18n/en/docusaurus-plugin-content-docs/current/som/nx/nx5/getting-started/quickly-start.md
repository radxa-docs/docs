...
The Radxa NX5 Development Kit consists of the Radxa NX5 compute module, Radxa NX5 IO Board, and active heatsink, providing a complete hardware development platform for quick validation of compute module functionality, performance evaluation, and prototype system building to help users efficiently complete development and solution verification.
