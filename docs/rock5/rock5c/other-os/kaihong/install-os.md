...
下载 [DriverAssistant](https://dl.radxa.com/tools/windows/DriverAssitant.zip) 并解压 DriverAssistant，然后执行 DriverInstall.exe 并点击 `Install Driver` 按钮来安装驱动。
...
解压 `RKDevTool_Release.zip` 后，点击 `RKDevTool.exe` 即可使用。
