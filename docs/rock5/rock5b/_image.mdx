...
<li style={{ display: `${props.rock5bp_system_img ? "block" : "none"}` }}>
  {" "}
  <a href="https://github.com/radxa-build/rock-5b-plus-6_1/releases/download/rsdk-t4/rock-5b-plus-6_1_bookworm_kde_t4.output.img.xz">
    {" "}
    ROCK 5B+ 系统镜像: Radxa ROCK 5B+ Debian test build 4{" "}
  </a>
</li>
