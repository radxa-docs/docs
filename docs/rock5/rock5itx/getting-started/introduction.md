...
<table>
  ...
  <tr>
    <th>FAN</th>
    <th>提供 4 个散热器安装孔，安装孔距 75 毫米，可与英特尔 LGA 115x 型散热器兼容。为带风扇的散热器提供了 ATX 标准风扇座。不支持风扇转速码表。<br/>注：安装孔直径为 3.5 mm，与标准 LGA 115x 散热器的 4.03 mm 不同，这是因为本板 SoC 高度低于普通 Intel 处理器。因此散热器背板会比常规安装略微突出，若要将本板安装到机箱中，请注意预留空间，或选择主板托盘带开孔的机箱。</th>
  </tr>
  <tr>
    <th>屏接口</th>
