...
<table>
  ...
  <tr>
    <th>FAN</th>
    <th>提供 4 个散热器安装孔，安装孔距 75 毫米，可与英特尔 LGA 115x 型散热器兼容。为带风扇的散热器提供了 ATX 标准风扇座。不支持风扇转速码表。<br/>注意：安装孔孔径为 3.5mm，并非标准 LGA 115x 的 4.03mm，这是因为本板 SoC 高度低于常规 Intel 处理器。因此散热器背板会比标准情况略微突出，若需装入机箱请注意预留空间，或选择主板托架带有开孔设计的机箱。</th>
  </tr>
  <tr>
    <th>屏接口</th>
