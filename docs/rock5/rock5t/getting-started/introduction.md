...
<table>
   <tr>
    ...
    <tr>
        ...
        <td colspan="2" align="center">M.2 B Key 连接器，可提供 USB 信号并支持 4G 模块。通过使用 SIM 卡，可方便地连接移动网络。<br/>M.2 M Key 连接器，共提供两个双通道 PCIe 3.0 接口，标准的 M.2 2280 安装孔，可以安装 M.2 2280 NVMe 固态硬盘。原生不支持 SATA 协议，但可通过转接板使用 SATA 设备。<br/><small>详细 M.2 接口协议说明请参考<a href="/common/m2-interface">M.2 接口协议说明</a></small></td>
    </tr>
    <tr>
