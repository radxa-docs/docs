...
- 主板：瑞莎 ROCK 5T
- 系统启动介质：microSD 卡
- 供电设备：标准 DC 12V/2A 电源适配器（DC-5525 接口；支持 DC 9-20V 输入，推荐 12V）
- 显示设备：显示器和 HDMI 数据线
- 输入设备：键盘和鼠标（用于图形界面操作）
...
完成系统的写入后，将 microSD 卡安装到 ROCK 5T 的 microSD 卡槽中，然后使用 DC 12V 电源适配器（支持 9-20V 输入，推荐 12V）给 ROCK 5T 供电，即可启动系统。
