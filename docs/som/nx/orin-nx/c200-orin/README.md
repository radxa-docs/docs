...
搭载 6 核 Arm® Cortex®-A78AE 处理器，主频高达 2GHz，集成 NVIDIA Ampere 架构 GPU，支持高达 117 TOPS 的 AI (MAXN_SUPER 模式)，是工业自动化、机器人、智能安防等领域的理想选择。
...
| AI 性能    | 正常模式<br/>• AI 算力：70 TOPS@INT8（稀疏算力）<br/>• GPU 频率：765 MHz<br/>升级 MAXN_SUPER 模式 <br/>• AI 算力：117 TOPS@INT8（稀疏算力）<br/>• GPU 频率提升 34.7% (765 -> 1173 MHz) <br/>• AI 算力提升 67.1% (70 -> 117 TOPS)                                                                     |
