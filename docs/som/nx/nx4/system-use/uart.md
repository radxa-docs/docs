...
将 USB 串口数据线连接到瑞莎 NX4 开发套件的 UART 接口，另一端连接到 PC 的 USB 端口。
...
| 瑞莎 NX4 开发套件引脚功能              | 连接方式                                                                       |
| -------------------------------------- | ------------------------------------------------------------------------------ |
| 瑞莎 NX4 开发套件 : GND（Pin6）        | 瑞莎 NX4 开发套件的 GND 引脚连接 USB 串口数据线的 GND 引脚（黑色杜邦线）       |
| 瑞莎 NX4 开发套件 : UART0_TXD（Pin8）  | 瑞莎 NX4 开发套件的 UART0_TXD 引脚连接 USB 串口数据线的 RXD 引脚（白色杜邦线） |
| 瑞莎 NX4 开发套件 : UART0_RXD（Pin10） | 瑞莎 NX4 开发套件的 UART0_RXD 引脚连接 USB 串口数据线的 TXD 引脚（绿色杜邦线） |
