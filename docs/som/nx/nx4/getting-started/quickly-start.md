...
本节教程将指导您快速上手使用瑞莎 NX4，配合瑞莎 C200 HDMI 版本，帮助您快速验证瑞莎 NX4 功能。

## 产品实物

瑞莎 NX4 开发套件由瑞莎 NX4 和瑞莎 C200 HDMI 版本组成，可用于快速验证核心板功能。
...
系统启动正常后，瑞莎 C200 HDMI 版本上的电源指示灯绿色亮起，瑞莎 NX4 上的状态指示灯蓝色闪烁。
