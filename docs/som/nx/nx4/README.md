...
瑞莎 C200 NX4 载板专为 Radxa NX4 打造，支持快速功能验证与原型搭建，方便用户在短时间内完成上电调试、接口评估及应用开发上手。
...
瑞莎 C200 NX4 载板可用于快速验证瑞莎 NX4 功能，方便用户快速上手。

|      产品实物      | 序号 |  视图  | 序号 |  视图  |
| :----------------: | :--: | :----: | :--: | :----: |
| 瑞莎 C200 NX4 载板 |  ①   | 俯视图 |  ②   | 背视图 |
...
由瑞莎 NX4 和瑞莎 C200 NX4 载板组成，可用于快速验证核心板功能、评估性能并搭建原型系统，帮助用户高效完成开发与方案验证。
