...
:::warning
不能将 CM5 安装到瑞莎 CM3 载板上使用，因为二者硬件不兼容。具体原因请参考[常见问题](../faq)。
:::
...
提供 M.2 E Key 接口，可兼容市面上常见的 PCIe 网卡，如瑞莎无线模块 A8。
...
瑞莎 CM5 载板配备了全功能 Type-C 接口，支持 DP 显示以及连接 USB Hub 设备。

## USB

提供 1 个 USB 3.0 主机接口和 2 个 USB 2.0 主机接口。
...
:::tip
瑞莎建议使用[瑞莎 8 英寸高清显示屏](/accessories/display/lcd-8-hd)或[瑞莎 10 英寸全高清显示屏](../../../accessories/display/lcd-10-fhd)。
:::
...
| GPIO 编号 |    功能 5    |   功能 4    |    功能 3    |   功能 2    |   功能 1    |              引脚号              |             引脚号              |  功能 1  |                  功能 2                   |    功能 3    |    功能 4    |   功能 5    | GPIO 编号 |
| --------- | :----------: | :---------: | :----------: | :---------: | :---------: | :------------------------------: | :-----------------------------: | :------: | :---------------------------------------: | :----------: | :----------: | :---------: | --------- |
