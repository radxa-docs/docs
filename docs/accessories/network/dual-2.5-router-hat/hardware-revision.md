...
- **物料编号**：A1J02.00103
- **连接器型号**：A2504-02AWB（闻川）
- **脚间距**：2.5mm
- **规格**：1×2PIN，卧贴，SMD
- **兼容接头**：JST PH 2P（2.5mm 间距）Housing
- **注意**：此接口为 12V 直流供电输出，不支持 PWM 调速
...
- **物料编号**：A1J02.00096
- **连接器型号**：ZX-XH2.54-2PLT（Megastar/兆星）
- **脚间距**：2.54mm
- **规格**：1×2PIN，立贴，SMD，无定位柱
- **兼容接头**：标准 JST PH 2P（2.54mm 间距）Housing
- **注意**：此接口为 12V 直流供电输出，不支持 PWM 调速
