...
#### 2-Pin 12V Power Output Interface Specifications

- **Part Number**: A1J02.00103
- **Connector Model**: A2504-02AWB (闻川/Wenchuan)
- **Pitch**: 2.5mm
- **Type**: 1×2PIN, horizontal SMD
- **Compatible Housing**: JST PH 2P (2.5mm pitch)
- **Note**: This interface is a 12V DC power output only — it does not support PWM fan speed control
...
- **Part Number**: A1J02.00096
- **Connector Model**: ZX-XH2.54-2PLT (Megastar/兆星)
- **Pitch**: 2.54mm
- **Type**: 1×2PIN, vertical SMD, no locating peg
- **Compatible Housing**: Standard JST PH 2P (2.54mm pitch)
- **Note**: This interface is a 12V DC power output only — it does not support PWM fan speed control
