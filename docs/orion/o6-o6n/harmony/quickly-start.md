...
<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/android/android-install-system.webp" style={{width: '100%', maxWidth: '1200px'}} />
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/android/burn-bios-go.webp" style={{width: '50%', maxWidth: '1200px'}} />
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/android/burn-bios-manager.webp" style={{width: '100%', maxWidth: '600px'}} />
</div>

_进入 Boot Manager_

<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/android/burn-bios-efi.webp" style={{width: '100%', maxWidth: '600px'}} />
</div>

_选择 EFI Shell_

<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/android/burn-bios-sh.webp" style={{width: '100%', maxWidth: '600px'}} />
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/harmony/burn-harmony-bios.webp" style={{width: '100%', maxWidth: '600px'}} />
</div>
...
<div style={{textAlign: 'center'}}>
    <img src="/img/orion/o6/harmony/burn-harmony-img.webp" style={{width: '100%', maxWidth: '600px'}} />
</div>
