...
- **使用说明**：见 [Orion O6 / O6N 飞牛 fnOS](./o6/other-os/fnos.md)
...
**适用于此芯 P1 的镜像（UEFI ARM 安装镜像 ISO）**

| 文件名                                          | 版本               | 下载链接                                                                                                                                                                              |
| :---------------------------------------------- | :----------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `fnos_Mainland-PE_arm_1.1.31_armsr_1366.iso`    | `1.1.31 / 1366`    | [下载](https://iso.liveupdate.fnnas.com/arm/trim/1.1.31/armsr/fnos_Mainland-PE_arm_1.1.31_armsr_1366.iso)                                                                          |

镜像版本号与构建号会随飞牛 fnOS ARM 公测版本迭代而变化，请以 [飞牛 fnOS ARM 镜像下载页](https://www.fnnas.com/download-arm) 发布的最新版本为准。
...
### 瑞莎星睿 O6N
        ...
        | 2D 文件 | `radxa_orion_o6n_2d_dxf_v1.11` | DXF | [下载](https://dl.radxa.com/orion/o6n/docs/hw/radxa_orion_o6n_2d_dxf_v1.11.zip) |
