...
| 序号 | 说明                                           | 序号 | 说明                | 序号 | 说明                |
| ---- | ---------------------------------------------- | ---- | ------------------- | ---- | ------------------- |
| 1    | USB Type-C 接口（支持 DP 视频输出 不支持供电） | 9    | 12V DC 供电（5525） | 17   | M.2 B Key 3042 插槽 |
| 2    | 4-Pin 风扇接口（支持 PWM 调速与测速）          | 10   | 标准 DP 接口        | 18   | Nano SIM 卡槽       |
| 3    | 40-Pin GPIO 排针                               | 11   | 标准 HDMI 接口      | 19   | 此芯 P1 SoC         |
| 4    | MIPI CSI 接口（4-lane）                        | 12   | 2x USB 3.0 Type-A   | 20   | SPI Nor Flash(BIOS) |
| 5    | LPDDR5                                         | 13   | USB 2.0 Type-A      | 21   | UFS 模块接口        |
| 6    | M.2 E Key 2230 插槽                            | 14   | 电源按键            | 22   | RTC 电池接口        |
| 7    | MIPI CSI 接口（4-lane）                        | 15   | 5V / 12V 电源接口   | 23   | 2x 2.5G 以太网      |
| 8    | M.2 M Key 2280 插槽                            | 16   | M.2 M Key 2280 插槽 | 24   | 2x USB 2.0 Type-A   |
