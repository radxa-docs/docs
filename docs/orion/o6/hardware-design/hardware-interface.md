...
| ②    | [M.2 M 键](#circle-2)      | ⑪    | [双 USB 2.0](#circle-11)        | ㉑   | [F_USB 连接器](#circle-21)   |
| ③    | [M.2 E 键](#circle-3)      | ⑫    | [USB-C 端口](#circle-12)        | ㉒   | [TP 连接器](#circle-22)      |
| ④    | [板载状态 LED](#circle-4)  | ⑬    | [电源按钮](#circle-13)          | ㉓   | [F\_面板连接器](#circle-23)  |
| ⑤    | [复位按钮](#circle-5)      | ⑭    | [风扇连接器](#circle-14)        | ㉔   | [调试连接器](#circle-24)     |
| ⑥    | [耳机插孔](#circle-6)      | ⑮    | [BIOS 闪存座](#circle-15)       | ㉕   | [eDP 连接器](#circle-25)     |
| ⑦    | [RJ45 以太网](#circle-7)   | ⑯    | [40 针 GPIO 连接器](#circle-16) | ㉖   | [RTC 电池座](#circle-26)     |
| ⑧    | [DP 端口](#circle-8)       | ⑰    | [CPU Cix CD8180](#circle-17)    |      |                              |
...
O6 主板上的 F\_音频连接器旨在支持机箱的前面板音频功能。引脚配置如下：
...
### <span id="circle-23">F\_面板连接器</span> [㉓](#o6-layout)

O6 主板上的 F\_面板连接器用于支持机箱的前面板电源按钮、复位按钮和 LED 功能。引脚配置如下：
