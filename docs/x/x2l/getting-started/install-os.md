...
<li>您可以选择以下任意操作执行：</li>
<br/>
<li>激活 eMMC：在开机之前，按住 <InlineSuccess>eMMC Recovery 按钮</InlineSuccess> 并保持，于此同时按下并立刻松开 <InlineSuccess>电源按钮</InlineSuccess>，直到显示器亮起后即可松开<InlineSuccess>eMMC Recovery 按钮</InlineSuccess>。</li>
<li><a href="../bios/emmc-availability">设置 eMMC 激活状态</a></li>
</ul>
