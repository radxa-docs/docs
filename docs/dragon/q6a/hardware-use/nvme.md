...
1. 将 M.2 2230 SSD 以约 30 度角插入卡槽
2. 轻轻按下 SSD 使其与卡槽接触良好
3. 使用 M2×3mm 螺丝将 SSD 固定到主板上
4. 确保螺丝紧固但不过度用力，避免损坏螺纹

:::note 固定螺丝规格
- **螺丝尺寸**：M2×3mm（公制螺纹，直径 2mm，长度 3mm）
- **螺丝类型**：平头十字螺丝
- **安装扭矩**：建议 0.15-0.2 N·m（1.5-2.0 kgf·cm）

如果包装中未包含 M.2 固定螺丝，可以使用标准 M2×3mm 平头十字螺丝。
:::
