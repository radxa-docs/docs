...
序号 10 为 12V 外部电源输入接口，为 3-Pin 排针，引脚功能如下：
...
使用 12V 电源的正极和负极分别连接到主板的 12V 和 GND 引脚，可对主板进行供电。
...
默认情况下，主板关机状态，PWR 引脚和 GND 引脚短接一下，主板启动；主板开机状态，PWR 引脚和 GND 引脚短接一下，主板出现关机菜单栏。
