...
4. 如当前版本低于 260825，按照[查看 BIOS 版本](../system-config/check-bios-version)和[烧录 BIOS 固件](../low-level-dev/spi-fw)的官方说明完成 BIOS 升级；升级完成后重新确认版本。

:::warning
BIOS 升级期间请保持供电稳定，不要中断操作。仅在 BIOS 版本低于 260825 时，才需要按官方流程进入 EDL 模式并升级 BIOS 固件。
:::
...
- BIOS 已为 260825 或更新版本时，无需进入 EDL 模式或更新 BIOS 固件；仅当 BIOS 版本低于要求时，才按第 1.3 节的官方流程升级。
