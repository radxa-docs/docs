...
瑞莎 Dragon Q8B 板载 3 个 USB-C、2 个 USB 2.0 Type-A 和 2 个 USB 3.2 Gen2 Type-A 接口。

<div style={{textAlign: 'center'}}>
   <img src="/img/dragon/q8b/q8b_usb.webp" style={{width: '80%', maxWidth: '1200px'}} />
</div>

1. USB-C 接口

仅支持 20 V 给主板供电，兼容 PD 协议。
...
理论上最大传输速率为 480Mbps，接口内部颜色为黑色。

4. USB 3.2 Gen2 Type-A 接口

理论上最大传输速率为 10Gbps，接口内部颜色为蓝色。
