...
:::danger
使用 USB 串口数据线和 Cubie A7S 进行串口登录时，请确保引脚连接正确，接错引脚可能会导致主板硬件损坏。
...
<div style={{textAlign: 'center'}}>
  <img src="/img/cubie/a7s/a7s-uart-login.webp" style={{width: '100%', maxWidth: '1200px'}} />
</div>

| Cubie A7S 引脚功能 | 连接方式 | USB 转 TTL 模块 / USB 转串口数据线引脚 |
| ------------------ | -------- | -------------------------------------- |
| GND（Pin6）        | 杜邦线   | GND                                    |
