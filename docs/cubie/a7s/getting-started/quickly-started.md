...
本节教程目的是为了让大家快速上手使用 Cubie A7S 产品。
...
推荐用户使用显示器、键盘和鼠标搭配 Cubie A7S 使用。

:::tip 推荐配件
Cubie A7S 主板兼容 PD 协议的 5V Type-C 电源输入，建议电流 3A 以上，确保所有外设稳定运行。
...
<div style={{textAlign: 'center'}}>
   <img src="/img/cubie/a7s/a7s-quickly-start.webp" style={{width: '100%', maxWidth: '1200px'}} />
</div>
...
:::tip 其它启动系统方式
对于想通过其它方式启动系统的用户（如 eMMC 启动系统），可以参考下面教程完成对应系统启动介质安装系统：
