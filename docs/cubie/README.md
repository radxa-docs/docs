...
| Cubie A7S | 全志 A733，2× A76 + 6× A55，最高 2.0GHz           | 3 TOPS@INT8       | LPDDR5：最高 16GB                            | 可选 eMMC（最高 256GB）              | microSD，PCIe 3.0 FPC（x1，支持 NVMe） | 千兆以太网，Wi‑Fi 6，蓝牙 5.4                                  | USB‑C DP Alt 4K@60，1× MIPI CSI               | 15/30-Pin GPIO，双 USB‑C，USB 2.0 Type‑A |
...
### Cubie A7S：口袋级高性能边缘 AI 单板

- 51×51mm 超紧凑尺寸，在口袋级体积内集成全志 A733 八核（2× A76 + 6× A55）与 3 TOPS NPU，兼顾性能、功耗与体积。
- LPDDR5 最高 16GB，支持 USB‑C DisplayPort 4K 输出与 4K 编解码，适合 AI 视觉、智能终端与人机交互。
- 千兆以太网 + Wi‑Fi 6 / 蓝牙 5.4，PCIe 3.0 x1 FPC 可扩展 NVMe SSD 高速存储。
- 15-Pin + 30-Pin GPIO 排针，支持 UART、I2C、I2S、PWM 等，扩展灵活。
- 更适合：空间受限但需要较强边缘 AI 算力、多媒体输出与高速存储扩展的嵌入式/机器人项目。
