...
请下载 [balenaEtcher-1.19.16.Setup.exe](https://github.com/balena-io/etcher/releases/download/v1.19.16/balenaEtcher-1.19.16.Setup.exe)。下载完成后，无需进行额外操作，双击即可打开使用。
...
按照上述步骤成功烧录 microSD 卡后，将 microSD 卡插入 {props.product} 的 MicroSD 插槽内，使用 {props.power_supply} 电源适配器上电，然后系统开始启动，HDMI显示桌面。
