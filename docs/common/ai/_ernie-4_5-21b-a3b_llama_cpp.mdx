...
<Tabs>
    ...
    ```bash
    cd llama.cpp
    python3 convert_hf_to_gguf.py ./ERNIE-4.5-21B-A3B-PT-Q4_0.gguf
    ```
    ...
    ```bash
    cd llama.cpp
    python3 convert_hf_to_gguf.py ./ERNIE-4.5-21B-A3B-Base-PT-Q4_0.gguf
    ```
    </NewCodeBlock>
...
<Tabs>
    ...
    ```bash
    cd llama.cpp
    ./build/bin/llama-quantize ERNIE-4.5-21B-A3B-PT/ERNIE-4.5-21B-A3B-Base-PT-F16.gguf ERNIE-4.5-21B-A3B-PT/ERNIE-4.5-21B-A3B-Base-PT-Q4_0.gguf Q4_0
    ```
    </NewCodeBlock>
