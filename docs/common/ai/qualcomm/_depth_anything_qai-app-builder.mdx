此文档讲述使用 [QAI AppBuilder](../qai-appbuilder) Python API 利用 Qualcomm® Hexagon™ Processor (NPU) 推理 [Depth-Anything](https://aihub.qualcomm.com/models/depth_anything)
深度估计模型。
...
- 执行推理
  ...
  <div style={{ textAlign: "center" }}>
    <img
      src="/img/fogwise/airbox-q900/qairt_depth_anything_output.webp"
      style={{ width: "65%" }}
    />
    output image
  </div>
