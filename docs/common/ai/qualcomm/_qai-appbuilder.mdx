...
编译完成会在 `dist` 目录下生成一个 `qai_appbuilder-2.42.0.68-cp312-cp312-linux_aarch64.whl` 文件
...
请在 `ai-engine-direct-helper/samples/python` 下创建 `qai_libs` 软链接，用于链接 QAIRT SDK 里的 `lib/aarch64-oe-linux-gcc11.2` 目录
...
:::tip
QCS6490 Demos 运行示例可参考 [**Demos 示例**](./qai-appbuilder-demo)
:::
...
:::tip
QCS9075 Demos 运行示例可参考 [**Demos 示例**](./qai-appbuilder-demo)
:::
