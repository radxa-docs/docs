...
- 请在 [Qualcomm® Software Center](https://softwarecenter.qualcomm.com/catalog/item/Qualcomm_AI_Runtime_Community?osArch=Any&osType=All&version=2.42.0.251225) 下载 `2.42.0.251225` QAIRT SDK
...
- 拉取 docker 镜像
  ...
  <TabItem value="QCS6490" default={props.tag === "qcs6490"} attributes={{className: props.tag !== "qcs6490" && "tab_none"}}>
          ...
          提示：在 `radxazifeng278/qairt-npu-9075:v1.1` 镜像中，QAIRT 目录位于 `/root/qairt`。进入容器后如果不确定路径，可使用以下命令确认：
