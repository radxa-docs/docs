此文档讲述使用 [QAI AppBuilder](../qai-appbuilder) Python API 利用 Qualcomm® Hexagon™ Processor (NPU) 推理 [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose)
姿态识别模型。
...
- 准备输入图片，这里以以下图片为输入示例
  ...
  <div style={{ textAlign: "center" }}>
    <img
      src="/img/fogwise/airbox-q900/qairt_openpose_input.webp"
      style={{ width: "65%" }}
    />
    input image
  </div>
...
- 执行推理
  ...
  <div style={{ textAlign: "center" }}>
    <img
      src="/img/fogwise/airbox-q900/qairt_openpose_output.webp"
      style={{ width: "65%" }}
    />
    output image
  </div>
