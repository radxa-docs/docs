瑞莎 Cubie A5E/A7A 的 SoC 搭载 Vivante VIP9000 系列 NPU， 利用 Vivante Machine Learning SDK，
可以帮助用户部署多种 AI 模型到 Cubie A5E/A7A 上使用 VIP9000 系列 NPU 进行硬件加速推理。 Vivante Machine Learning SDK 支持多种模型框架，如 TensorFlow, TensorFlow Lite, PyTorch, Caffe, DarkNet, ONNX, Keras 等框架模型的转换，
Vivante Machine Learning SDK 可将多种 AI 模型编译成可以在 Vivante VIP9000 系列 NPU 推理的模型格式。
