...
| ------------------------------------------------------------------- | ---------------------------------------- | -------------- |
| [Radxa Stable Diffusion](#安装-radxa-stable-diffusion-文生图-app)   | radxazifeng278/radxa_sd_app:0.3.0        | 8999           |
...
| [Radxa Llama3 chatbot](#安装-radxa-llama3-chatbot-聊天机器人-app)   | radxazifeng278/radxa_llama3_app:0.1.0    | 8003           |
...
:::tip
启动 Llama3 Chatbot 时请关闭其他 TPU 相关 App, 否则存在底层不兼容情况
:::
