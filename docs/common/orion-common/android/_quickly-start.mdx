...
访问 <a href={props?.download_page ?? '../download.md#android'}>资源汇总下载</a> 页面，下载最新的安卓 BIOS 文件，并将其解压到 U 盘的根目录。

### 硬件连接

:::tip 接口说明
{props.board} 主板配备两个 USB Type-C 接口：
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/orion/o6/android/burn-bios-fastboot.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
访问 <a href={props?.download_page ?? '../download.md#android'}>资源汇总下载</a> 页面，下载最新的 Android 系统镜像，并将其解压到您的 PC 本地。
