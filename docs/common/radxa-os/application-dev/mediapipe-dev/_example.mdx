...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_face_detection.webp"
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_face_mesh.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_hands.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_pose.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_holistic.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_seg.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/radxa-os/application-dev/mediapipe_3d_object.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
