...
<div style={{textAlign: 'center'}}>
    <img src="/img/common/tools/radxa-os/ssh-login.webp" style={{width: '100%', maxWidth: '1200px'}} />
</div>
</TabItem>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-welcome.webp"
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-profile.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-template.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-ssh-parameter.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-ssh-connect.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-ssh-verify.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-ssh-password.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/tabby-ssh-success.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
