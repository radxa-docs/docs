...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-download.webp"
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-01.webp"
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-02.webp"
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-03.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-04.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-05.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-06.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-install-07.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-windows-use-01.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  VNC Viewer 界面
  <img
    src="/img/common/tools/radxa-os/vnc-windows-use-02.webp"
    style={{ width: "100%", maxWidth: "600px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-connect-01.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
...
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-connect-02.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/tools/radxa-os/vnc-connect-03.webp"
    style={{ width: "100%", maxWidth: "1200px" }}
  />
</div>
