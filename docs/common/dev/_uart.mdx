...
请参照<a href="../../radxa-os/rsetup#overlays">设备树配置</a>启用 UART 相关 Overlay, eg: "Enable {props.uart1_name}"。
...
请参照<a href="../../radxa-os/rsetup#overlays">设备树配置</a>启用 UART 相关 Overlay, eg: "Enable {props.uart1_name}" 和"Enable {props.uart2_name}"。
