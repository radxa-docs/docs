...
**本文已提供预转换好的 yolov8.rknn 模型，用户可直接参考[板端推理 YOLOv8 ](#板端推理-yolov8)跳过 PC 端模型转换章节**
...
- 将 PC 端拷贝过来的 yolov8n.rknn 放入 /usr/share/rknn_model_zoo/examples/yolov8/model 目录，运行 yolov8.py 程序
