...
{props.product} 的板载 MIPI CSI 接口可用于连接[瑞莎 8M 219 摄像头](https://radxa.com/products/accessories/camera-8m-219)，实现图像采集功能。

<div style={{ textAlign: "center" }}>
  <img
    src="/img/common/accessories/camera-8m-219-view.webp"
...
使用 15-Pin 1.0 mm 间距转 {props.pins} {props.pitch}{props.orientation} FPC 排线

## 硬件连接

将 FPC 排线的 15-Pin 金属接触点末端插入摄像头接口，将 FPC 排线的 {props.pins} 金属接触点末端插入主板 MIPI CSI 接口。
...
<Image
  src="/img/common/accessories/camera-8m-219-#board#.webp"
  board={props.board}
