---
sidebar_position: 6
description: NIO12L 平台 MobileNetV3Small 模型的 Host 端转换与 Device 端部署完整流程
---
...
转换完成后，在 `mobilenet_v3_small/` 目录下生成：
...
结果保存在 `outputs/mobilenet_v3_small/classifications/` 目录下。
