...
转换完成后，在 `examples/mobilenet_v3_small/model/` 目录下生成：

- `int8/mobilenet_v3_small_mtk_int8.tflite`
- `fp32/mobilenet_v3_small_mtk_fp32.tflite`
...
结果保存在 `outputs/mobilenet_v3_small/classifications/`。
