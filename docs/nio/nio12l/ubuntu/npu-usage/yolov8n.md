---
sidebar_position: 11
description: NIO12L 平台 YOLOv8n 模型的 Host 端转换与 Device 端部署完整流程
---
...
转换完成后，在 `examples/yolov8n/model/` 目录下生成：
...
```bash
wget -P examples/yolov8n/model/int8 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n_int8.dla
wget -P examples/yolov8n/model/fp32 https://github.com/Ronin-1124/nio12l-model-zoo/releases/download/v2026.05.11-dla/yolov8n_fp32.dla
```
...
结果保存在 `outputs/yolov8n/` 目录下（`vis/` 为可视化图片，`detections/` 为 JSON）。
