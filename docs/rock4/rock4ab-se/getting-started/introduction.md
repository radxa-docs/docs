...
ROCK 4A/ROCK 4A+/ROCK 4B/ROCK 4B+/ROCK 4SE 提供了丰富的接口，包括多个 USB 、HDMI 等接口，便于连接外部设备和扩展功能。详见详见[参数配置](#参数配置)。

### 配件生态丰富

ROCK 4A/ROCK 4A+/ROCK 4B/ROCK 4B+/ROCK 4SE 支持多款摄像头和显示屏， 另外 40-PIN 兼容市面上大多数的传感器模块。
...
ROCK 4A/ROCK 4A+/ROCK 4B/ROCK 4B+/ROCK 4SE 提供了完整的硬件设计原理图和软件源代码，这一特性使得大多 DIY 设计爱好者和开发者进行个性化修改和功能拓展，吸引了一众开源爱好者活跃在社区，有利于促进知识共享和技术创新。
