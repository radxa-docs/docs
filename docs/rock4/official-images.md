...
ROCK 4 系列系统镜像可从以下仓库下载：

- **[ROCK 4 Image Release](https://github.com/radxa-build)** - 官方持续发布的最新镜像。
...
请参考 [third party images](./alternative-os/third-party-images)。
